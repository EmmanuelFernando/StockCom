...
class Destinos extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('codigo, nombre, capacidad', 'required'),
			array('codigo, capacidad', 'numerical', 'integerOnly'=>true),
			array('nombre', 'length', 'max'=>30),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, codigo, nombre, capacidad', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'asignaciones' => array(self::HAS_MANY, 'Asignaciones', 'destino_id'),
		);
	}
